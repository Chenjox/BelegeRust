...
fn gradient_sensitivity_sj(min: f64, max: f64, order: i32) -> f64 {
    ...
    let a2 = 1.0/5.0 * ( 161_000.0 * diff_of_squares(min, max, 1) - 320_000.0/2.0 * diff_of_squares(min, max, 2) ) * diff_of_squares(min, max, 5) * diff_of_squares(min, max, 1);
    let a3 = 1.0/4.0 * (- 160_000.0/3.0 * diff_of_squares(min, max, 3) - 1600.0 * diff_of_squares(min, max, 1)) * diff_of_squares(min, max, 4) * diff_of_squares(min, max, 1);
    let a4 = 1.0/3.0 * ( 40804.0 * diff_of_squares(min, max, 1) - 161_600.0/2.0 * diff_of_squares(min, max, 2) + 160_000.0/3.0 * diff_of_squares(min, max, 3) ) * diff_of_squares(min, max, 3) * diff_of_squares(min, max, 1);
    let a5 = 1.0/2.0 * ( - 80800.0/3.0 * diff_of_squares(min, max, 3)*diff_of_squares(min, max, 1) - 808.0 * diff_of_squares(min, max, 1).powi(2) + 160_000.0/6.0 * diff_of_squares(min, max, 2) * diff_of_squares(min, max, 3) + 800.0 * diff_of_squares(min, max, 2) * diff_of_squares(min, max, 1) ) * diff_of_squares(min, max, 2);
    let a6 = (40000.0/5.0 * diff_of_squares(min, max, 5) + 800.0/3.0 * diff_of_squares(min, max, 3) + 4.0 * diff_of_squares(min, max, 1)) * diff_of_squares(min, max, 1).powi(2);
